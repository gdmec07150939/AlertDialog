...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tView=(TextView)this.findViewById(R.id.textView2);
    ...
    public void dialog1(){
        ...
        dialog.setButton(DialogInterface.BUTTON_POSITIVE,"确认",lis1);
        dialog.setButton(DialogInterface.BUTTON_NEUTRAL,"取消",lis1);
        dialog.show();
    }
    public void dialog2(){
        dialog=new AlertDialog.Builder(this).create();
    ...
    public void dialog3(){
        ...
        dialog.setButton(DialogInterface.BUTTON_POSITIVE,"确认",lis3);
        dialog.show();
    }
    public void dialog4(){
        final String item[]=new String[] {"北京","上海","广州"};
        final boolean bSelect[]=new boolean[item.length];
        DialogInterface.OnMultiChoiceClickListener om1=new DialogInterface.OnMultiChoiceClickListener(){
            @Override
        ...
        builder.setMultiChoiceItems(item,null,om1);
    ...
    public void dialog7(){
        ...
        View layout=inf.inflate(R.layout.diydialog,null);
        final EditText tEdit=(EditText) layout.findViewById(R.id.textText);
        dialog=new AlertDialog.Builder(this).create();
